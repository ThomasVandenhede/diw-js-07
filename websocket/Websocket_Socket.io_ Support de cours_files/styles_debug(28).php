...
.path-mod-workshop .userplan tr.phasetasks li {
    background-image: url(/theme/image.php?theme=virtuoworks&component=mod_workshop&image=userplan%2Ftask-todo);
...
.path-mod-workshop .userplan tr.phasetasks li.completed {
    background-image: url(/theme/image.php?theme=virtuoworks&component=mod_workshop&image=userplan%2Ftask-done);
}

.path-mod-workshop .userplan tr.phasetasks li.fail {
    background-image: url(/theme/image.php?theme=virtuoworks&component=mod_workshop&image=userplan%2Ftask-fail);
}

.path-mod-workshop .userplan tr.phasetasks li.info {
    background-image: url(/theme/image.php?theme=virtuoworks&component=mod_workshop&image=userplan%2Ftask-info);
}
