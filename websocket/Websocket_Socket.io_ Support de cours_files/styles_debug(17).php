...
.path-mod-forum .preload-subscribe {
    background: url(/theme/image.php?theme=virtuoworks&component=mod_forum&image=t%2Fsubscribed) no-repeat -9999px -9999px;
}

.path-mod-forum .preload-unsubscribe {
    background: url(/theme/image.php?theme=virtuoworks&component=mod_forum&image=t%2Funsubscribed) no-repeat -9999px -9999px;
}
