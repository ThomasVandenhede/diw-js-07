...
.block_navigation .block_tree .tree_item.branch {
    padding-left: 21px;
    cursor: pointer;
    background-image: url('/theme/image.php?theme=virtuoworks&component=core&image=t%2Fexpanded');
}

.block_navigation .block_tree .tree_item.emptybranch {
    padding-left: 21px;
    background-image: url('/theme/image.php?theme=virtuoworks&component=core&image=t%2Fcollapsed_empty');
}

.block_navigation .block_tree .tree_item.loadingbranch {
    background-image: url('/theme/image.php?theme=virtuoworks&component=core&image=i%2Floading_small');
}
...
.jsenabled .block_navigation .block_tree li.collapsed .tree_item.branch {
    background-image: url('/theme/image.php?theme=virtuoworks&component=core&image=t%2Fcollapsed');
}
...
.dir-rtl .block_navigation .block_tree .tree_item.emptybranch {
    padding-right: 21px;
    padding-left: 0;
    background-image: url('/theme/image.php?theme=virtuoworks&component=core&image=t%2Fcollapsed_empty_rtl');
}
...
.dir-rtl.jsenabled .block_navigation .block_tree .collapsed .tree_item.branch {
    background-image: url('/theme/image.php?theme=virtuoworks&component=core&image=t%2Fcollapsed_rtl');
}
