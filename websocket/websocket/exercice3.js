...
/**
  I. Coté client : On doit pouvoir afficher le document HTML contenant la liste de tous les messages envoyés précédemment et envoyer des messages au serveur et en recevoir du serveur à n'importe quel moment.
  ...
  3. A la soumission du formulaire vous devez envoyer le contenu du formulaire (le pseudonyme et le message) au serveur WebSocket. Pensez à empêcher le navigateur Internet de produire une requête HTTP à la soumission du formulaire.
...
/**
  II. Coté serveur : On doit pouvoir recevoir des messages provenant de n'importe quel client, les sauvegarder en base de données, et les envoyer à tous les clients connectés.
