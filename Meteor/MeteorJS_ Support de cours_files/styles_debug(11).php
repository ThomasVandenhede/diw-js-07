...
.path-mod-assign.jsenabled .mod-assign-history-link-open {
    padding: 0 5px 0 20px; background: url(/theme/image.php?theme=virtuoworks&component=core&image=t%2Fexpanded) 2px center no-repeat;
}

.path-mod-assign.jsenabled .mod-assign-history-link-closed {
    padding: 0 5px 0 20px; background: url(/theme/image.php?theme=virtuoworks&component=core&image=t%2Fcollapsed) 2px center no-repeat;
}

.path-mod-assign.dir-rtl.jsenabled .mod-assign-history-link-closed {
    padding: 0 20px 0 5px; background: url(/theme/image.php?theme=virtuoworks&component=core&image=t%2Fcollapsed_rtl) 2px center no-repeat;
}
